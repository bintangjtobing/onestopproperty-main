                            ...
                            <div class="row justify-content-end">
                                <div class="col-md-7">
                                    <div class="position-relative">
                                        ...
                                        <img src="{!! asset('landing-2/images/hero-iphone-2.png') !!}" alt="onestoproperty Image" width="220"
                                        ...
                                        <img src="{!! asset('landing-2/images/hero-iphone.png') !!}" alt="onestoproperty Image" width="220"
                                            class="parallax position-absolute mb-5" style="right: 0; bottom: -60px;"
            ...
            <div class="container py-lg-6 mw-md mt-5">
                ...
                <div class="text-center mb-lg-6">
                    <h2 class="mb-1 display-6 fw-bold">Kenalan dengan <span class="circle-draw"><span>tim
                                ...
                                <path
                                    d="M98.269,102.723c191.518,50.4,433.149-14.254,403.627-69.23C469.212-.827,218,3,94,25.5S-30.549,100.9,109.5,115c138.587,5.83,313.427-3.644,362.5-34.5,30.5-19.177,82.988-57.915-47-74.937"
                                    transform="translate(-0.645 -3.32)" fill="none" stroke="var(--cnvs-themecolor)"
                            ...
                            <div class="card border-0 bg-color rounded-6 pt-0">
                                <div class="card-body text-center p-5 pt-0">
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <h4 class="mb-3 h6 fw-medium"><i class="bi-check-circle-fill me-2"></i>
                                                Estimasi jangkauan: 1,1K
                                                -
                                                3K
                                                per hari
                                            </h4>
                                            <h4 class="mb-3 h6 fw-medium"><i class="bi-check-circle-fill me-2"></i> Umur
                                                target: 35 - 55
                                                tahun</h4>
            ...
            <div class="section bg-transparent my-0 py-0 py-lg-5">
                <div class="container text-center">
                    <h2 class="display-4 font-secondary position-relative">
                        <svg class="promo-bg" xmlns="http://www.w3.org/2000/svg" width="612.879" height="132.494"
                    ...
                    <a href="https://s.id/yukIklankan" target="_blank"
                        class="button button-xlarge px-5 rounded-pill text-dark bg-color h-op-09 mb-5">Coba
