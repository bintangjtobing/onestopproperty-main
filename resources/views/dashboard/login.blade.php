...
<head>
    ...
    <link rel="shortcut icon" href="{!! asset('osp/Asset1@3x.png') !!}" type="image/png">
    ...
    <div class="container-xxl">
        <div class="authentication-wrapper authentication-basic container-p-y">
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="mb-2">Selamat datang di admin <br><span
                                style="font-size:1.8rem;font-weight:700;">OSP CENTER</span> 👋</h4>
